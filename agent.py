...
class Actor(nn.Module):
	def __init__(self, state_dim, action_dim, max_action):
		...
		self.l1 = nn.Linear(state_dim, config['agent_hidden'])
		self.l2 = nn.Linear(config['agent_hidden'], config['agent_hidden'])
		self.l3 = nn.Linear(config['agent_hidden'], action_dim)
...
class Critic(nn.Module):
	def __init__(self, state_dim, action_dim):
		...
		# Q1 architecture
		self.l1 = nn.Linear(state_dim + action_dim, config['agent_hidden'])
		self.l2 = nn.Linear(config['agent_hidden'], config['agent_hidden'])
		self.l3 = nn.Linear(config['agent_hidden'], 1)

		# Q2 architecture
		self.l4 = nn.Linear(state_dim + action_dim, config['agent_hidden'])
